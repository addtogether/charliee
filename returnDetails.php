...
<?php
    ...
    $sql = mysqli_query($conn, "SELECT * FROM returnMaster WHERE id = {$_GET['o']}");
                ...
                <div class="col-md-9 col-lg-9 col-xl-9">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="verticalLine">
                                <h4><?php echo date('d F Y', strtotime($returnDate)); ?></h4>
                            </div>
                                ...
                                <table id="myTable" class="table table-striped display">
                                    ...
                                    <tbody id="returnList">
                                        <?php
                                            ...
                                            $totalAmount = 0;
                                            $totalQuantity = 0;
                                            $sql3 = mysqli_query($conn, "SELECT * FROM returnMaster 
                                            ...
                                            while($row3 = mysqli_fetch_assoc($sql3)){
                                                ...
                                                echo '<tr>
                                                        ...
                                                        <td><a href="retailersReturn.php?o='.$row3['id'].'">'.$row4['retailerName'].'</a></td>';
