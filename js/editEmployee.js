...
const editEmployeeIdField = document.getElementById("editEmployeeID");
const editEmployeeManagerField = document.getElementById("editEmployeeManager");
const employeePhotoPreviewField = document.getElementById("employeePhotoPreview");
...
// employee manager dropdown initial
    ...
    formData.append("designationDropdownSelected",editEmployeeManagerField.value);
    xhr.send(formData); // sending form data to php
