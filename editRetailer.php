              ...
              <form action="" class="needs-validation">
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="country" id="country" pattern="[a-zA-Z'-'\s]*" placeholder="Country" value="<?php echo $row['country']; ?>" aria-describedby="inputGroupPrepend" required>
                      <div class="invalid-feedback">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="workingDays" data-role="tagsinput" id="workingDays" required>
                    <div class="invalid-feedback">
